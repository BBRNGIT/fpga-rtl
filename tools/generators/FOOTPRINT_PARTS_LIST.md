...
- `DOM_BID_QTY` — Bid quantity per price level (indexed)
  - Source: `dom` module
  - Type: `u64`

- `DOM_ASK_QTY` — Ask quantity per price level (indexed)
  - Source: `dom` module
  - Type: `u64`
...
```
FP_VAH            — 64-bit flip-flop
                            Comment: Value area high
                            Type: u64
```

```
FP_VAL            — 64-bit flip-flop
                            Comment: Value area low
                            Type: u64
```
...
FP_ASK_VOL[16384]    — 64-bit flip-flop array
                                        Depth: 16384 entries
                                        Index: PRICE_IDX
                                        Comment: Ask volume accumulator per price level
                                        Type: u64
```
...
FP_BID_VOL[16384]    — 64-bit flip-flop array
                                        Depth: 16384 entries
                                        Index: PRICE_IDX
                                        Comment: Bid volume accumulator per price level
                                        Type: u64
```
