/* cells.h — branchless flip-flop / gate primitives for the adapter device.
 *
 * Owned by the real adapter tree. Built fresh to the build approach
 ...
 */
#ifndef ADAPTER_CELLS_H
#define ADAPTER_CELLS_H
