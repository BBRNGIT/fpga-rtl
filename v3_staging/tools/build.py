...
STAGES = [s for s in [
    ...
    _opt(("richtext — UG1085 cache -> registers/fields/address-map/routing", [PY, os.path.join(HERE, "richtext.py"),
          os.path.join(HERE, "cache", "ug1085-zynq-ultrascale-trm.jsonl")]),
         os.path.join(HERE, "cache", "ug1085-zynq-ultrascale-trm.jsonl")),
    _opt(("figblocks — UG1085 figures -> block-diagram connectivity", [PY, os.path.join(HERE, "figblocks.py"),
          os.environ.get("PS_PDF", os.path.join(REPO, "ug1085-zynq-ultrascale-trm.pdf"))]),
         os.environ.get("PS_PDF", os.path.join(REPO, "ug1085-zynq-ultrascale-trm.pdf"))),
